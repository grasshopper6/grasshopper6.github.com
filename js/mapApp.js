...
Copyright (C) <2002-2011>  <Andreas Neumann>
Version 1.2.3, 2011-10-02
a.neumann@carto.net
http://www.carto.net/
...
1.2.3 (2011-10-02)
improved the navigator detection to correctly handle MSIE
...
function mapApp(adjustVBonWindowResize,resizeCallbackFunction) {
	...
	if (window.navigator) {
		...
		if (window.navigator.userAgent) {
			...
			if (window.navigator.userAgent.match(/MSIE/gi)) {
				this.navigator = "MSIE";
			}
		}
	}
